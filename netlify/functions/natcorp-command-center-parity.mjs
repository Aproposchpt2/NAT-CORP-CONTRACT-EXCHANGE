...
export default async function handler(req){
  ...
  try{
    ...
    if(action==='launch_discovery'){
      ...
      const scope=getStatePublisherDefinedScope(payload.scope_id||payload.publisher_id);if(!scope||scope.scope_type!=='STATE_PUBLISHER_DEFINED')return json(400,{ok:false,error:'Select a state Publisher Defined acquisition scope.'});
